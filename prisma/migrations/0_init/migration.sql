...
CREATE TABLE "User" (
    ...
    "Adresse" TEXT NOT NULL DEFAULT '12 Evergreen Terrace',
    "Fanclub" TEXT NOT NULL DEFAULT 'Nordkurve12',
    "Land" TEXT NOT NULL DEFAULT 'Deutschland',
    "Ort" TEXT NOT NULL DEFAULT 'Leverkusen',
    "Plz" TEXT NOT NULL DEFAULT '51373',
    "Telefon" TEXT NOT NULL DEFAULT '0172-85858',
